    ...
    if st.session_state.graph is not None:
        ...
        if st.session_state.safest_route is not None:
            ...
            **Why this proves optimality:**  
            - The **Safest Route** has a **lower accessibility score** (lower is better) than the Shortest Route, meaning it avoids stairs, unsheltered sections, and dangerous crossings.  
            ...
            # Safety message for the safest route
