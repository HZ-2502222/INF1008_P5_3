...
Usage
Upon running the script, the application initialises the Punggol neighbourhood graph. 
It will output: 
The starting location (e.g., Blk 273C).
The destination (e.g., Digital Clinic). 
The calculated optimal route dynamically avoids heavy penalties like stairs and unsheltered high-risk crossings.
